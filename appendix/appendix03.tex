...
\section{Dynamic Schema Extraction and Injection for Query Generation}
...
\section{Schema-Aware Text-to-Cypher Translation via Prompt Engineering}
...
\section{Transformation of XML into a Neo4j Knowledge Graph}
