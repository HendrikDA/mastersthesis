...
If \prototype{} is being run for the first time, then two containers need to be setup so that they are populated with the default data. From within the root folder of the project, execute the following commands
