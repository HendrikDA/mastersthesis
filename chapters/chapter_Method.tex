...
The schema-handling strategy was also improved via APOC. Rather than a hard-coded schema in the frontend, the schema is now retrieved before by calling a preexisting APOC function and the result is passed to the cypher-generating LLM. This ensures that the LLM understands how the knowledge-graph is structured and how it may query it for the information requested by the user's prompt. 
