...
After the fourth and final Action Research cycle, a hands-on workshop was conducted. The goal of the final review was to test \prototype{} with real-world EAM questions in order to identify how it handles tasks, what it does well, and what can be improved upon in future development. This review was by nature explorative in understanding how the system functions but also deemed as a summative evaluation. Thus, this review also marked the end of the development for the prototype. This section does not yet evaluate the results and only describes how the final review was conducted. The discussion of the results can be found in chapter \ref{ch:Discussion} and the improvements for future development can be found in section \ref{sub:conclusion:futureWork}.

Review setting and structure: The final review was conducted as a workshop between the researcher and both stakeholders, who acted as the domain experts. The workshop spanned four hours via an online meeting. Parallel testing of both systems along with open discussions were held. Each participant went about the testing in an explorative manner.

Evaluation Focus and Procedure:

Role and Comparative Testing: 
...
% Notes:
%“Am I describing how the evaluation was conducted, or what it means?” If it’s the second then move it out.
%Todo: Die Agendapunkte von Herrn Schloer noch einbauen. die 4 phasen des workshops, die er notiert hat müssen hier rein.
