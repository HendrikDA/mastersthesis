...
By applying the PRISMA framework as mentioned above, it was possible to reduce the number of sources from an initial count of \textit{todo} sources down to \textit{to do} sources after the first step and down to the final \textit{to do} sources after the final step.	
