...
Author Jung (2019) \cite{jung2019purpose} conducted eight interviews in which enterprise architects, consultants, and decision makers in the German logistics industry to identify concerns that  enterprise architecture management is expected to address in practice. The results highlight that stakeholders deal with recurring topics such as providing information about applications, optimizing application landscapes, and reducing the number of applications to save costs. These concerns form a practical starting point for examining how enterprise architecture data can be structured, queried, and analyzed in order to support questions about existing landscapes.
