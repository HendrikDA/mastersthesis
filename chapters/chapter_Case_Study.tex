...
Where, why, and by whom was the system used?

Put here:
- Enterprise Architecture domain
- Role of participants (e.g. EA, junior EA, workshop setting)
- Purpose of the case
- Why this case is relevant
Example content:
- “Masuta was evaluated in a workshop setting with EA practitioners”
- No opinions yet
- No success/failure claims
This grounds the entire evaluation.

% System Setup and Data
\section{System Setup and Data}
What exactly was deployed and with which data?
Prototype version
Architecture components (brief, not full architecture)
Read-only DB constraint
Data sources:
- Textbook data
- SpeedParcel XML? --> didn't really use it
- Fra UAS Architecture Diagram
Graph size / rough schema complexity
Prompting setup (system prompt, schema injection, etc.)
