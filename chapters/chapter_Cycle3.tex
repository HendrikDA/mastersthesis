...
Todo: Architekturdiagramme in Archi nachgebaut um daraus später exportieren zu können so wie im vort-ort termin es sein wird.

Todo: Sorge: Das Bauen des parsers habe ich bisher schritt für schritt und iterativ gemacht pro datei, die ich einlesen möchte. um beim vor-ort treffen mit herrn schlör nicht den halben tag am parser zu verlieren wäre es gut, wenn ich einen all-in-one parser hinkriege, der dynamisch die daten lesen kann, zusammenhänge verstehen kann, und alles in einem rutsch macht.

Todo: custom-Parser für die XML geschrieben (mit AI assistance) 

Todo: Kontextoptimierung hat hier stattgefunden.

Todo: Parallel den Speedparcel datensatz ausgebaut in archimate.
