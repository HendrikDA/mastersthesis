...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.4\textwidth]{./images/masuta_screenshot_question_answer_1.png}
}
...
\begin{lstlisting}[language=SQL, caption={Cypher query to retrieve application impact and decommission guidance},
  label={lst:cypher-statmanplus}]
