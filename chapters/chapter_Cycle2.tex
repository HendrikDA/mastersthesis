...
\begin{tikzpicture}
    ...
    \node at (0,0) {\textbf{C3}};
\end{tikzpicture}
\caption{A venn diagram of the three question categories identified, which the prototype must be able to answer.}
