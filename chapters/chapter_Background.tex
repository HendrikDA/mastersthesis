...
\label{ch:background}
This chapter goes in detail on various concepts and keywords in order to create a foundation of common understanding for the key elements of this thesis.
