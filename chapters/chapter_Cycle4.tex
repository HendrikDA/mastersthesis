...
On top of this, the practitioners expressed the requirement of a deployment method which would enable the prototype to run on any local system, a requirement for the planned final review.
