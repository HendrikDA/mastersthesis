...
The methodology chapter answers the question of how things were iteratively built and why. This chapter contains all information on what the finished \prototype{} prototype is, including its architecture, individual components, features, data processing mechanisms, and a sequence diagram of how data flows through the application.
