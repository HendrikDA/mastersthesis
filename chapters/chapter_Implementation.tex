...
Todo: Should we describe what Masuta does somewhere here as well? We've described the architecture and how the individual parts interact, but we haven't described its functionality in any way yet. Papa sagt JA!
...
% TODO: Rechtschreibfehler rechts im graph (covert statt convert 2 mal)
\begin{figure}[h]
\centering
\makebox[\textwidth][c]{%
